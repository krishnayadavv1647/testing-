...
export function createDeepgramLiveTranscriber({ apiKey = process.env.DEEPGRAM_API_KEY, onFinalTranscript } = {}) {
  if (!apiKey) {
  ...
  socket.on("error", (error) => {
    console.error("[Deepgram] Live transcription socket error", error.message);
  });
